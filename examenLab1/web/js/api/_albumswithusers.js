...
const albumswithusersAPI_auto = {

    /** Gets all entries from 'albumswithusers' */
    getAll: async function() {
        let response = await axios.get(`${BASE_URL}/albumswithusers`, requestOptions);
        return response.data;
    },
};

export { albumswithusersAPI_auto };